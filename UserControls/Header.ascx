<%@ Control Language="C#" AutoEventWireup="true" CodeFile="Header.ascx.cs" Inherits="RFFisio.Header" %>
<%@ Register Assembly="Telerik.Web.UI" Namespace="Telerik.Web.UI" TagPrefix="telerik" %>
	<telerik:RadCodeBlock ID="CustomHeaderCodeBlock" runat="server">
			<link rel="stylesheet" href="<%= ResolveUrl("~/Styles/Material_ButtonStyle.css") %>" type="text/css" media="screen" title="no title" charset="utf-8" />
			<link rel="stylesheet" href="<%= ResolveUrl("~/Styles/Material_Button_button_secondary.css")%>" type ="text/css" media="screen" title="no title" charset="utf-8" />
			...
			<div id="LayoutContainer1" runat="server" class="container-fluid c_Header_LayoutContainer1 c_Header_LayoutContainer1">
				<div id="LayoutRow1" class="row c_Header_LayoutRow1 c_Header_LayoutRow1">
					<div id="LayoutCol1" class="col col-12 c_Header_LayoutCol1 c_Header_LayoutCol1">
						<div id="Div1" runat="server" class="c_Header_Div1 div-transparent c_Header_Div1 div-transparent">
